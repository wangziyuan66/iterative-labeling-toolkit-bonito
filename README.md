...
Sample raw pod5 files are provided for **BioRNA-Leu** **BioRNA-Ser** **ChemoRNA-Leu** and **ChemoRAN-Ser**. In sra, only bam can be uploaded. If some need more rawdata, contact us. 
